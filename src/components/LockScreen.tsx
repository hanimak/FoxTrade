...
export function LockScreen({ onUnlock, theme = 'dark' }: LockScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center animate-in fade-in duration-700 overflow-hidden bg-black/40 backdrop-blur-[60px]">
